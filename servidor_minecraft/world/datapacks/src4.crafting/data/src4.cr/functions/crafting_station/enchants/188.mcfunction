#Prefix
data modify block 659 6 508 front_text.messages[1] set value '{"text":"Voidspiked ","italic":false,"bold":true}'
...
execute store result score $temp src4.cr run data get storage src4.cr:main StandItem.tag.Enchantments[{id:"minecraft:thorns"}].lvl
scoreboard players add $temp src4.cr 5
data remove storage src4.cr:main StandItem.tag.Enchantments[{id:"minecraft:thorns"}]
data modify storage src4.cr:main StandItem.tag.Enchantments append value {id:"minecraft:thorns",lvl:1s}
execute store result storage src4.cr:main StandItem.tag.Enchantments[{id:"minecraft:thorns"}].lvl short 1 run scoreboard players get $temp src4.cr
