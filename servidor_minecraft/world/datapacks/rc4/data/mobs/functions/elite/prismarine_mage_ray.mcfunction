...
execute as @s[scores={ray_range=44}] run function mobs:elite/prismarine_mage_see2
kill @s[scores={ray_range=44..}]
execute as @s[scores={ray_range=..43}] run function mobs:elite/prismarine_mage_ray