...
execute at @s[scores={cd=300..}] run function mobs:elite/bee_keeper_summon_1
execute at @s[scores={cd=300..,mob_animation=..2}] run function mobs:elite/bee_keeper_summon_2
