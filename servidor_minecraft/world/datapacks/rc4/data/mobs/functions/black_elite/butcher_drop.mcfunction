execute at @s[scores={cd=-40}] run function mobs:black_elite/butcher_drop_start
...
execute at @s run particle dust 0.282 0.208 0.353 1 ~ ~1 ~ 0.4 0.7 0.4 0.1 12 normal
