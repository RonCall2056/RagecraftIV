...
execute at @s run particle block purple_concrete ~ ~1 ~ 0.7 0.7 0.7 0.05 100 normal
...
execute at @s run execute as @a[distance=..3] run damage @s 20 magic by @e[type=piglin_brute,limit=1,sort=nearest,tag=vt_butcher]
