...
execute as @s[scores={ray_range=55}] run function mobs:black_elite/dreadmage_see2
kill @s[scores={ray_range=55..}]
execute as @s[scores={ray_range=..54}] run function mobs:black_elite/dreadmage_ray