...
execute as @s[scores={ray_range=25}] run function mobs:voidtouched/beholder_see2
kill @s[scores={ray_range=25..}]
execute as @s[scores={ray_range=..24}] run function mobs:voidtouched/beholder_ray