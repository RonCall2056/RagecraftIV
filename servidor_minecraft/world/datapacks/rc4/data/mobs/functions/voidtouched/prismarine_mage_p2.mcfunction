...
execute at @s[scores={cd=30..}] positioned ^ ^ ^0.17 unless block ~ ~0.6 ~ #minecraft:nonsolid run function mobs:voidtouched/prismarine_mage_p3
execute at @s[scores={cd=30..}] positioned ^ ^ ^0.17 if entity @p[distance=..1] run function mobs:voidtouched/prismarine_mage_p3
execute at @s[scores={cd=30..}] positioned ^ ^ ^0.17 if block ~ ~0.6 ~ #minecraft:nonsolid run tp @s ^ ^ ^

execute at @s[scores={cd=180..}] run function mobs:voidtouched/prismarine_mage_p3