...
execute unless entity @p[tag=unlocked_cyan] run data modify storage page_11_name page_11_name set value ['{"text":"Empyrian Gardens"}','{"text":"----------------\\n"}']

tag @s add unlocked_cyan
