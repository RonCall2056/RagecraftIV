...
execute unless entity @p[tag=unlocked_purple] run data modify storage page_12_name page_12_name set value ['{"text":"Dreadfire Stronghold"}','{"text":"----------------\\n"}']

tag @s add unlocked_purple
