...
execute at @s if entity @p[distance=..6] run summon armor_stand ~ ~-0.8 ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Small:1b,Invisible:1b,Tags:["marker_tick","crypt_keeper_bomb","bomb_1"],Passengers:[{id:"minecraft:snowball",Tags:["crypt_keeper_bomb"],Item:{id:"minecraft:snowball",Count:1b,tag:{CustomModelData:5}}}],CustomName:'{"text":"Malevolent Mine","color":"red","bold":false,"italic":false}'}