...
scoreboard players set #rc4tick crypt_keeper_phase 6

tellraw @a[x=-346,y=0,z=-387,dx=170,dy=92,dz=150] [{"text":"[Crypt Keeper] ","color":"red","bold":true,"italic":false},{"text":"Your persistence is starting to annoy me. Turn around while you still can, or you shall be destroyed!","color":"red","bold":false,"italic":false}]
