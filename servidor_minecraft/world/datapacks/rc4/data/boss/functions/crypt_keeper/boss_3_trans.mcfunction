...
scoreboard players set #rc4tick crypt_keeper_phase 4

tellraw @a[x=-346,y=0,z=-387,dx=170,dy=92,dz=150] [{"text":"[Crypt Keeper] ","color":"red","bold":true,"italic":false},{"text":"Foolish human! Your hate only makes me stronger.","color":"red","bold":false,"italic":false}]
