...
execute if score #black_elite_count cd matches 1.. run scoreboard players set #black_skill_1_23 cd 1
execute unless score #black_elite_count cd matches 1.. run scoreboard players set #black_skill_1_13 cd 1