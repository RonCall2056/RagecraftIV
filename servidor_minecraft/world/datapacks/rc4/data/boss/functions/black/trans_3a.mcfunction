function boss:black/arena_reset_3

scoreboard players set #black_trans_3_running cd 1

execute in abyss run summon marker 281 75 1655 {Tags:["marker_tick","black_skill_marker","trans_marker"]}
