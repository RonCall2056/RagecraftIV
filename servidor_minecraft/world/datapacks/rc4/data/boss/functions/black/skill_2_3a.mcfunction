...
execute as @e[type=end_crystal,tag=arena_1_middle] at @s run execute as @p[distance=..70] at @s positioned ^ ^ ^4 run summon marker ~-11 ~5 ~1 {Tags:["marker_tick","black_skill_marker","black_skill_2_1","black_skill_2_1_2"]}
execute as @e[type=end_crystal,tag=arena_1_middle] at @s run execute as @p[distance=..70] at @s positioned ^ ^ ^4 run summon marker ~4 ~5 ~8 {Tags:["marker_tick","black_skill_marker","black_skill_2_1","black_skill_2_1_3"]}
