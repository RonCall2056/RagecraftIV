#ranged variant of twisted thrall
...
execute at @s[scores={cd=60..}] run summon skeleton ~ ~ ~ {DeathLootTable:"none",CanPickUpLoot:0b,Health:18f,Tags:["custom","twisted_thrall"],CustomName:'{"text":"Twisted Thrall","color":"red","bold":false,"italic":false}',HandItems:[{id:"minecraft:bow",Count:1b,tag:{CustomModelData:24,Enchantments:[{id:"minecraft:power",lvl:5s}]}},{}],HandDropChances:[0.000F,0.085F],ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:2952781}}},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:1181724}}},{id:"minecraft:leather_helmet",Count:1b,tag:{display:{color:2952781}}}],ArmorDropChances:[0.000F,0.085F,0.000F,0.000F],Attributes:[{Name:"generic.max_health",Base:18},{Name:"generic.follow_range",Base:30},{Name:"generic.movement_speed",Base:0.25}]}
kill @s[scores={cd=60..}]