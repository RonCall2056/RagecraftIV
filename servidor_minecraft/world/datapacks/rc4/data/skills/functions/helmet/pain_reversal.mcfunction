...
execute at @s[nbt={ActiveEffects:[{Id:9}]}] run effect give @p[predicate=skills:pain_reversal,distance=..12] resistance 1 0 true
...
execute at @s[nbt={ActiveEffects:[{Id:26}]}] run effect give @p[predicate=skills:pain_reversal,distance=..12] fire_resistance 1 0 true