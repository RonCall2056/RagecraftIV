execute at @s run particle block nether_wart_block ~ ~0.3 ~ 0.3 0.5 0.3 0.05 20 normal
execute at @s run particle damage_indicator ~ ~0.3 ~ 0.3 0.4 0.3 0.05 6 normal
...
scoreboard players remove @s slice_5 1
