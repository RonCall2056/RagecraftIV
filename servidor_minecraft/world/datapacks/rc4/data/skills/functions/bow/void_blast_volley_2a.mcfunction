execute at @s run summon arrow ^ ^ ^ {crit:1b,Tags:["arrow_done","void_blast","volley","volley_2a"],Passengers:[{id:"minecraft:armor_stand",Silent:1b,Marker:1b,Invisible:1b,Small:1b,Invulnerable:1b,Tags:["marker_tick","void_blast"]}]}
