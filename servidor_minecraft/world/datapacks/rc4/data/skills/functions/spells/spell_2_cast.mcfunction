...
execute as @e[type=armor_stand,tag=spell_marker_2] at @s rotated as @p[tag=cast_spell_2] run tp ^ ^ ^

execute as @e[type=armor_stand,tag=spell_marker_2] at @s run function skills:spells/spell_2_raycast
