...
execute at @s[scores={cd=50..}] run function skills:spells/spell_9_trigger2
execute at @s unless entity @e[type=snowball,tag=meteor,distance=..2] run execute at @s run function skills:spells/spell_9_trigger2
execute at @s[scores={cd=15..}] unless block ~ ~0.5 ~ #minecraft:nonsolid run execute at @s run function skills:spells/spell_9_trigger2