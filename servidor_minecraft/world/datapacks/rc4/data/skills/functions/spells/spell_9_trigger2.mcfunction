...
execute at @s run particle explosion ~ ~0.7 ~ 0.2 0.2 0.2 1 1 force
execute at @s run particle minecraft:lava ~ ~1 ~ 0.3 0.5 0.3 0.2 20 force
execute at @s run particle dust 0.561 0.133 0.024 1 ~ ~1 ~ 0.8 0.5 0.8 0.01 100 force
...
execute at @s run execute as @e[type=#minecraft:hostile,tag=!spell_immune,distance=..4] run function skills:spells/spell_9_hit2
