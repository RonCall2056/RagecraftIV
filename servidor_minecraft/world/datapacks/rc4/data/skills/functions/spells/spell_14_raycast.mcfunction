execute at @s[tag=!spell_power] run function skills:spells/spell_14_damage
execute at @s[tag=spell_power] run function skills:spells/spell_14_damage_2
...
execute at @s run particle dragon_breath ~ ~ ~ 0.15 0.15 0.15 0.01 5 normal
...
execute at @s[scores={ray_range=24..},tag=tp_position] run tp @p[tag=cast_spell_14] ~ ~ ~

execute at @s[scores={ray_range=24..},tag=tp_position] run function skills:spells/spell_14_tp

execute as @s[scores={ray_range=..23}] run function skills:spells/spell_14_raycast
