...
title @a title {"text":"Agent Wildfire has been rescued","color":"green","bold":false,"italic":false}
...
execute at @e[type=villager,tag=r2_blacksmith_a] run particle flash ~ ~1 ~ 0.3 0.3 0.3 0.1 1 normal
execute at @e[type=villager,tag=r2_blacksmith_a] run particle portal ~ ~1 ~ 0.8 0.8 0.8 0.05 300 normal
execute at @e[type=villager,tag=r2_blacksmith_a] run particle falling_obsidian_tear ~ ~1 ~ 0.6 0.6 0.6 0.05 200 normal

execute as @e[type=villager,tag=r2_blacksmith_a] at @s run tp @s ~ ~-300 ~
kill @e[type=villager,tag=r2_blacksmith_a]